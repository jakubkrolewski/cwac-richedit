...
/*
  Spanned temp() {
    ...
    append(b, "The quick brown fox\n", new BulletSpan(8), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
    append(b, "jumped over the lazy dog", new BulletSpan(8), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);

    return(b);
  }

  void append(SpannableStringBuilder b, String s, Object what, int flags) {
    int start=b.length();

    b.append(s);
    b.setSpan(what, start, b.length(), flags);
  }
*/
}
